...
Amazon GuardDuty is a continuous security monitoring service that uses machine learning to detect threats in your AWS environment. It analyzes CloudTrail, VPC Flow Logs, and DNS logs to identify malicious activity. Pricing is $4/GB of analyzed logs.
